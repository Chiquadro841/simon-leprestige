...
with col3:
    ...
    st.markdown(
        "<div style='text-align:center; font-weight:bold; margin-top:18px;'>Language</div>", 
        unsafe_allow_html=True
    )

    # CSS per centrare e spostare in alto la selectbox
    st.markdown("""
        <style>
            div[data-baseweb="select"] {
                display: block;         /* centra la selectbox */
                margin-left: auto;
                margin-right: auto;
                max-width: 120px;
